...
(\.|^)dualstack\.
(\.|^)*eu-irl*\.
(\.|^)([-a-z0-9]+)-?courier\.push\.(apple|akadns)\.(com|net)$
(\.|^)([0-9]+)\.courier-push-apple\.com\.akadns\.net$
(\.|^)([0-9]+)\.client-?channel\.google\.com$
...
(\.|^)ambientweather\.net$
(\.|^)ampcid\.google\.com$
(\.|^)andr\.na\.ec\.api\.amazonvideo\.com$
(\.|^)ap\.spotify\.com$
(\.|^)api\.amazon
(\.|^)api\.amazon\.com$
(\.|^)api\.apps\.apple\.com$
...
(\.|^)spot\.im$
(\.|^)statuspage\.io$
(\.|^)storage\.firebase\.com$
(\.|^)stripe\.com$
(\.|^)stripe\.network$
(\.|^)tools\.ietf\.org$
(\.|^)tpt\.cloud$
(\.|^)twimg\.com$
(\.|^)uiboot\.geo\.netflix\.com$
(\.|^)uiboot\.netflix\.com$
(\.|^)updates-http\.cdn-apple\.com$
(\.|^)vp\.nyt\.com$
(^|\.)([-a-z0-9])?\.?\.?ntv\.
(^|\.)([-a-z0-9])?\.?frame\.ly
(^|\.)([-a-z0-9])?\.?usnyc\.icloud-?content\.
(^|\.)([-a-z0-9]+.)?\.?doubleverify\.
(^|\.)([-a-z0-9]+.)?\.?hawk\.
(^|\.)([-a-z0-9]+.)?\.?osnova\.
(^|\.)([-a-z0-9]+)?\.?iot.us-east-1.amazonaws.com
(^|\.)*altmetric*\.
(^|\.)*appdevelopergroup*\.
(^|\.)*availability*\.
(^|\.)*badges*\.
...
(^|\.)og([a-z0-9])\.google\.
(^|\.)stats?\.wp\.
(^|\.)video-?rolls\.row\.aiv-?cdn\.net
\.?([-0-9a-z])?d(ns|oh|ot[0-9]?\b)([-0-9a-z]+)?\.
\.?cdn-?([0-9]+)\.
\.*.swscan*.\.
\.amazon\.(au|br|ca|cn|de|es|fr|in|it|jp|mx|nl|uk)$
\.dash\.row\.
\.health\.
\.tenor\.com?
\bad(s|v)?\b
...
^.*chargebee.*\.
^.*chartbeats?.*\.
^.*check(s|ing)?-?connect(s|ed|er|ivity|ion).*\.
^.*chimp-?static.*\.
^.*chimp.*\.
^.*citeseerx.*\.
^.*ckeditor.*\.
...
^.*cognito.*\.
^.*cohorts?.*\.
^.*collect(s|er|or|ed|ing|ion)?.*\.
^.*com-?scores?.*\.
^.*comments?.*\.
^.*complianz.*\.
^.*connatix.*\.
^.*connect(ers?|ors|ed|ing|ions?)?.*\.
^.*connect(s|ed|er|ivity|ion)?-?check(s|ing)?.*\.
^.*connect(s|er|or|ed|ing|ion)?.*\.
^.*consent.*\.
^.*consumers?.*\.
^.*contact-?track?(e|er|ed|ing).*\.
^.*contact-?track?ing.*\.
^.*context.*\.ly
^.*contextly.*\.
^.*contributors?.*\.
...
^.*cryptocompare.*\.
^.*customers?.*\.
^.*data-?connect(ers?|ors|ed|ing|ions?)?.*\.
^.*data(dog)?(hq)?.*\.
^.*daypass.*\.
^.*db-ip.*\.
^.*(abc|act|ads|ae[0-9][0-9]|alpha|android|api|app(s|spot)?|ar-ar|atlas|attachments?|badge|beta(net)?|bidder|business|boost(com)?|business|channel|check[0-9]?|chat|clients?|connect|deloitte|developers?|devs?|doh|dns|edge(ray)?|en-[a-z]([a-z])?|ent-[a-z]|error|es-{a-z}[a-z]|external|fbcallback|fbcdn-?(s?photos?|profiles?|videos?)|fb-?external|fb-lt|flex|fr-[a-z][a-z]|free-?(basics?)?|general-?electric|graph-photos?|graph-profiles?|graph-videos?|hootsuite|hphotos?|hr-hr|hu-hu|huawei|id-id|instgrm|intern|investor|inyour|iphone|landmarkgroup|latest|live(rail)?|login|lookaside|mail|messenger|mobile|mtouch|national|ncontent|newsec|news(room)?|nic|nike|nl-nl|nokia|norcap|noroestecom|nova|ns[0-9]|photos?|mqtt|ocbc|onepublicservice|onevedanta|orcart|origincache|oculus|pa-in|pacific|pixel|pl-pl|platform|postmaster|prod|promis|pt-br|pt-pt|register|research|ro-ro|ru-ru|rupload|static|savethechildren|scontent|secure|sk-sk|snaptu|softtech|ssl|stanleyblackanddecker|star-mini|star|static|stormberg|streaming-?(graph)?|sonar|snaptu|staging|tunnel|telenor|touch|uploads?|vpn|v?thumbs?|vupload|watchdog|webdav|whatsapp|wooga|work|www?[0-9]?|zero|zh-cn).*\.(fbcdn|fbsbx|fburl|instagram|tfbnw)\.

^.*(abc|act|ads|ae[0-9][0-9]|alpha|android|api|app(s|spot)?|ar-ar|atlas|attachments?|badge|beta(net)?|bidder|business|boost(com)?|business|channel|check[0-9]?|chat|clients?|connect|deloitte|developers?|devs?|doh|dns|edge(ray)?|en-[a-z]([a-z])?|ent-[a-z]|error|es-{a-z}[a-z]|external|fbcallback|fbcdn-?(s?photos?|profiles?|videos?)|fb-?external|fb-lt|flex|fr-[a-z][a-z]|free-?(basics?)?|general-?electric|graph-photos?|graph-profiles?|graph-videos?|hootsuite|hphotos?|hr-hr|hu-hu|huawei|id-id|instgrm|intern|investor|inyour|iphone|landmarkgroup|latest|live(rail)?|login|lookaside|mail|messenger|mobile|mtouch|national|ncontent|newsec|news(room)?|nic|nike|nl-nl|nokia|norcap|noroestecom|nova|ns[0-9]|photos?|mqtt|ocbc|onepublicservice|onevedanta|orcart|origincache|oculus|pa-in|pacific|pixel|pl-pl|platform|postmaster|prod|promis|pt-br|pt-pt|register|research|ro-ro|ru-ru|rupload|static|savethechildren|scontent|secure|sk-sk|snaptu|softtech|ssl|stanleyblackanddecker|star-mini|star|static|stormberg|streaming-?(graph)?|sonar|snaptu|staging|tunnel|telenor|touch|uploads?|vpn|v?thumbs?|vupload|watchdog|webdav|whatsapp|wooga|work|www?[0-9]?|zero|zh-cn).*\.(fbcdn|fbsbx|fburl|tfbnw|whatsapp)\.

^.*activat(e|ed|es|er|or|ions?|ing).*\.

^.*clients?-?(beacons?|data|find(er|ing)|info(mation)?|loc(ated?|ater|ating|ations?|ors?)?|logs?|map(s|ping)|metri(c|x)s?|track(er|ing)?|us(e|age))?*\.

^.*personaliz(e|ed|er|es|ation|ing).*\.
